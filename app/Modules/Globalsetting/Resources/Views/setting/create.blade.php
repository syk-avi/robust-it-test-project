...
@section('title') Add Setting Information  @endsection
@section('breadcrumbs')
    <a class="breadcrumb-item"> Global Setting </a>
    <span class="breadcrumb-item active">Global Setting Create</span>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Global Setting Create </h5>

        </div>


        <div class="card-body pt-2">
            {!! Form::open(['route' => 'globalsetting.store','method'=>'POST','class'=>'form-horizontal','user'=>'form','files' => true]) !!}
