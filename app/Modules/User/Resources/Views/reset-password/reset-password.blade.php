...
<div class="page-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content d-flex justify-content-center align-items-center" style="flex-wrap: wrap">
            ...
            {!! Form::open(['route' => 'resetPassword','method'=>'POST','id'=>'sign_in']) !!}
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-3" style="overflow: hidden">
                            ...
                            <span class="d-block text-muted">Enter new password</span>
                        </div>
                        @include('flash::message')


                        {!! Form::hidden('email', $email, ['id'=>'email','placeholder'=>'Email','class'=>'form-control','autofocus']) !!}
